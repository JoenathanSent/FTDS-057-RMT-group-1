...
def run_ram_32gb_ddr5():
    # Membuat title 
    st.title('DealSense')

    # Membuat sub header
    st.subheader('Halaman ini berisi Exploratory Data Analysis (EDA) mengenai dataset harga komponen RAM 32GB DDR5')
    ...
    fig.axes[1].set_title('Tren Rata-rata Harga RAM 32GB DDR5')
