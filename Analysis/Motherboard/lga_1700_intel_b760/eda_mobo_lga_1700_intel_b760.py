...
def run_lga_1700_intel_b760():
    ...
    # Menampilkan gambar
    image_path = os.path.join(CURRENT_PATH, 'Analysis', 'Motherboard', 'lga_1700_intel_b760', '8d9113cf-78f0-4f99-aa65-e6181f3248dc.jpg')
                              
    data = mpimage.imread(image_path)
    st.image(data, caption='EDA LGA 1700 Intel B760')
    df = pd.read_csv('./Analysis/Motherboard/lga_1700_intel_b760/lga_1700_intel_b760.csv')
    df['date'] = pd.to_datetime(df['date'])
    df = df.set_index('date')

    st.write('# Exploratory Data Analysis untuk komponen Motherboard LGA 1700 Intel B760')
    ...
    fig.suptitle('Visualisasi ACF dan PACF dari data pelatihan harga rata-rata Motherboard LGA 1700 Intel B760', fontsize=16)
    ...
    perform_adf_test(df_avg_price_train['avg'], series_name="Data Harga Rata-rata Motherboard LGA 1700 Intel B760")
